...
public interface GuiGameFeatures extends GameController {
   ...
   *
   * @param item  the item to be picked by the player
   */
  void pick(int item);

  /**
   * Method to respond to events for shooting arrows and shooting them in a given direction
   ...
   * @param xOne  the x-coordinate of the player location
   * @param yOne  the y-coordinate of the player location
   * @param xTwo  the x-coordinate of the location to be moved to
   * @param yTwo  the y-coordinate of the location to be moved to
   */
