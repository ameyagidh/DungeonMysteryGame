...
public class Shoot implements GameCommand {
   ...
   * @param distance  the number of caves the arrow should possibly travel
   * @throws IllegalArgumentException if the direction string is invalid or the distance is non-integer
   */
  ...
  /**
   * Checks if the arrow hit a monster.
   *
   * @return true if the arrow hit a monster, otherwise false
   */
  boolean hitMonster() {
