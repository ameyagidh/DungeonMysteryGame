 ...
 * It can read commands from the user and execute them using the model.
 */
public class TextBasedGameController implements GameController {
  ...
  public void playGame() {
    ...
    try {
      this.out.append("Playing the game. Enter Q to quit abruptly at any point!\n\n");
  ...
  private boolean userAction(GameModel model) throws IOException {
    ...
    try {
      ...
      switch (action) {
        ...
        case "Q":
        case "quit":
          this.out.append("Quitting the game...");
          return false;
        ...
        case "shoot":
          ...
          this.out.append("Number of caves (1-5)? ");
      ...
      this.out.append("Invalid input type!\n");
    }
  ...
  private String locationInfo(Player player) {
    ...
    if (smell == Smell.LESS_PUNGENT) {
      sb.append("You smell something in the distance\n");
