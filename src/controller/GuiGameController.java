...
/**
 * The class representing the GUI controller for the dungeon adventure game.
 * This class provides features for the GUI, captures event callbacks, creates the model,
...
public class GuiGameController implements GuiGameFeatures {
  ...
  /**
   * Default constructor for the GUI controller. It inflates an 'enter dungeon parameters'
  ...
  /**
   * Constructor for the GUI controller where the model and view are constructed beforehand and passed.
   *
   * @param m the model
   * @param v the view
   */
