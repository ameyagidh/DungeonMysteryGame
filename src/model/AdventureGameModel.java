...
/**
 * The AdventureGameModel class represents the model for the Dungeon Adventure Game
 * and implements its functionalities. It contains methods to move the player one location at a time,
 * pick up treasure if available at a given location, and get the state of the game at any instant.
 */
public class AdventureGameModel implements GameModel {
  ...
  /**
   * Constructs an Adventure Game object with the given arguments.
   *
   * @param rand      The Random object, which can be truly random or deterministic
   * @param rows      The number of rows in the game dungeon
   * @param cols      The number of columns in the game dungeon
   * @param wrap      Whether the game dungeon needs to wrap (true for yes, false otherwise)
